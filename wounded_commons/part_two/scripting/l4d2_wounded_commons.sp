...
{
	name        = "[L4D2] Wounded Commons",
	author      = "Mart",
	description = "Add wounds to common infected on spawn",
	version     = PLUGIN_VERSION,
	url         = "https://forums.alliedmods.net/showthread.php?t=330902"
}
...
public void OnPluginStart()
{
	...
	CreateConVar("l4d2_wounded_commons_version", PLUGIN_VERSION, "[L4D2] Wounded Commons plugin version.", FCVAR_NOTIFY|FCVAR_DONTRECORD);
	...
	AutoExecConfig(true, "l4d2_wounded_commons");
}
